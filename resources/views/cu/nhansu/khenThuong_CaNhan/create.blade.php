...
@section('content')
    ...
    <form action="" method="post" class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" name="NgayKhenThuong">
        ...
        <div class="mb-3">
            ...
            <textarea type="text" class="form-control" id="exampleInputPassword1" name="ChiTietKhenThuong"
                placeholder="Nhập chi tiết khen thưởng..."></textarea>
        </div>
        @csrf
