    ...
    <form action="{{ route('khenthuong.update', ['id' => $khenthuong->id]) }}" method="post" class="mb-3">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control @error('TenKhenThuong') border border-danger border-3 @enderror"
                id="exampleInputEmail1" aria-describedby="emailHelp" name="TenKhenThuong"
        ...
        <div class="mb-3  mt-3">
            ...
            <input type="text" class="form-control @error('TienThuong') border border-danger border-3 @enderror"
                id="exampleInputEmail1" aria-describedby="emailHelp" name="TienThuong" value="{{ $khenthuong->TienThuong }}"
