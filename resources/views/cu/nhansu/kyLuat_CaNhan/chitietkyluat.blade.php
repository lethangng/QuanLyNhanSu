...
<body>
    ...
    <section class="home">
        ...
        <div class="container">
            <div class="header">
                <h1>Danh sách chi tiết kỷ luật</h1>
            </div>
    
            <div class="container-btn">
                <button class="btn-add">Thêm mới chi tiết kỷ luật </button>
            </div>
    
    
            <div class="input-search">
                <label>Tháng <input style="max-width:30%" type="text"></label>
                <label>Năm <input style="max-width:30%" type="text"></label>
                <br>
                <div>
                ...
                <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="head-table" scope="col">Tiền kỷ luật</th>
