        ...
        <div class="container">
            <div class="row">
                <div class="col-sm left-inf">
                        ...
                        <input class="inp-tmcv" type="text" placeholder="Nhập mã nhân viên">
                        <div class="label-name-tmpb">
                            <label for="">Tên nhân viên:</label>
                        </div>
                        <input class="inp-tmcv" type="text"  placeholder="Nhập tên nhân viên">
                        <div class="label-name-tmpb">
                            <label for="">Email:</label>
                        </div>
                        <input class="inp-tmcv" type="email" placeholder="Nhập email">
                        <div class="label-name-tmpb">
