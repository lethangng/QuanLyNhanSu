    ...
    <div class="qlbaocao-main">
        <div class="wrap">
            ...
            <div class="container tkhd">
                <h4>Thống kê kỉ luật</h4>

                <form class="form-tkhd" action="{{ route('thongkekyluat') }}" method="POST" id='submitForm'>
                    @csrf
                    <label class="nam" for="">Từ năm:</label>
                    <input class="inp-nam" placeholder="Nhập năm" name="nam1"  type="number" min="2011" max="2023" pattern="\d+" required>
                    <label class="nam" for="">Đến năm:</label>
                    <input class="inp-nam" placeholder="Nhập năm" name="nam2" type="number" min="2011" max="2023" pattern="\d+" required>
    ...
    @section('script')
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var options = {
                    'title': 'Thống kê kỷ luật các năm',
                    'height': 500,
                    // 'width': 600,
                    // 'legend': 'none'
                };
