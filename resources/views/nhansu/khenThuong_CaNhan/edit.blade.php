        ...
        <div class="mb-3">
            ...
            <select class="form-select select2" name="ThongTinCaNhan_id">
                @foreach ($caNhans as $caNhan)
                    <option @selected($khenThuong_CaNhans->ThongTinCaNhan_id === $caNhan->id) 
                        value="{{ $caNhan->id }}">{{ $caNhan->HoTen }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select class="form-select select2" name="KhenThuong_id">
                @foreach ($khenThuongs as $khenThuong)
                    <option @selected($khenThuong->id === $khenThuong_CaNhans->KhenThuong_id) 
                        value="{{ $khenThuong->id }}">{{ $khenThuong->TenKhenThuong }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
